...
/*** PENAMBAHAN ELEMEN ***/
void insertFirstUtas(UtasList *l, int IDUtas, USER user, STRING content)
...
void insertLastUtas(UtasList *l, int IDUtas, USER user, STRING content)
/* I.S. l mungkin kosong */
/* F.S. Melakukan alokasi sebuah elemen dan */
...
{
    if (isEmpty(*l)) {
        insertFirstUtas(l, IDUtas, user, content);
    }
    else {

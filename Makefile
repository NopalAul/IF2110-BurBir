...
main : $(OBJ_DRIVER) $(OBJ_WORD) $(OBJ_CHARM) $(OBJ_USER) $(OBJ_PCOLOR) $(OBJ_KICAUAN) $(OBJ_DATETIME) $(OBJ_LREQ) $(OBJ_MATRIX) $(OBJ_RELATION) $(OBJ_REPLY) $(OBJ_UTAS)
	$(CC) $(CFLAGS) -o $@ $^
...
clean:
	rm -f main $(OBJ_DRIVER) $(OBJ_WORD) $(OBJ_CHARM) $(OBJ_USER) $(OBJ_PCOLOR) $(OBJ_WORD_TEST) word_test $(OBJ_RELATION) $(OBJ_KICAUAN) $(OBJ_DATETIME) $(OBJ_RELATION) $(OBJ_MATRIX) $(OBJ_LREQ) $(OBJ_REPLY) $(OBJ_UTAS)